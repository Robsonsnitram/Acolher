...
<html lang="en">
    <head>
        ...
        <title>Acolher</title>
        <link rel="stylesheet" href="CSS/Agendamento.css?vteste=1">
    ...
    <body>
                            ...
                            <div class="pacien">
                                ...
                                <form action="cria_usuario.php" method="POST">
                                    ...
                                    <div class="paciente-1">
                                        ...
                                        <button class="teste_cpf" type="button" onclick="testarCPF()">Testar CPF</button>
                                        ...
                                        <button class="teste_cep" type="button" onclick="testarBuscaCEP()">Testar CEP</button>
                                        ...
                                        <datalist id="Atendimentos">
                                          ...
                                          <option value="Musicoterapeuta"></option>
                                        </datalist>
        ...
        <script src="../../../tests/teste_cep.js"></script>
        <script src="../../../tests/teste_cpf.js"></script>
