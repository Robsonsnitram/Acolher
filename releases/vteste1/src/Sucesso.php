...
<html lang="en">
    <head>
        ...
        <title>Acolher</title>
        <link rel="stylesheet" href="CSS/Sucesso.css?vteste=1">
        ...
        <meta http-equiv="refresh" content="5; url=Agendamento.php">
    </head>
    <body>
        ...
        <section class="Sucesso">
            <div class="Centro">
                ...
                <div class="Sucesso-Texto">
                    <h1>Cadastro realizado com sucesso! <i class="fa-solid fa-check"></i></h1>
