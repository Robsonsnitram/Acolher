...
<html lang="pt">
    <head>
        ...
        <title>Acolher</title>
        <link rel="stylesheet" href="CSS/Coordenacao.css?vteste=1">
    ...
    <body>
        ...
        <section class="Principal"><!--Iniciando Principal-->
            ...
            <div class="Centro">
                ...
                <div>
                    <button class="teste_senha" type="button" onclick="testarSenhaSistema()">Testar Sistema de Senha</button>
                </div>
        ...
        <script src="tests/teste_senha.js"></script>
