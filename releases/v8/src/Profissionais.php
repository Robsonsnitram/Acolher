...
<html lang="en">
    <head>
        ...
        <title>Acolher</title>
        <link rel="stylesheet" href="CSS/Profissionais.css?v=8">
        ...
        <section class="Principal"><!--Iniciando Principal-->
            ...
            <div class="Centro">
                ...
                <div class="Conteudo-cabecalho"><!--Abrindo cabecalho-->
                    ...
                    <img src="../src/IMG/Profissional_Ini.png" alt="Logotipo do “Espaço Acolher” com tipografia cinza-esverdeada e ícone de pessoa em forma de árvore, simbolizando acolhimento e crescimento.">
                    <h2>Profissionais</h2>
        ...
        <section class="Profissionais"><!--Abrindo profissionais-->
            ...
            <section class="Box-profissionais"><!--Abrindo Box profissionais-->
                ...
                <div class="Centro-profissionais"><!--Abrindo centro profissionais-->
                    ...
                    <div class="Profissionais-docentes">                           <!--Abrindo profissionais-->

                        <div class="Profissionais-foto-elisayne" ></div>    <!--Foto profissional-->

                        <div class="Profissionais-info">                    <!--Abrindo info profissional-->

                            <h2>Elisainy Rodrigues</h2>                     <!--Nome profissional-->
                            <h4>Pedagoga e Psicopedagoga</h2>               <!--Função profissional-->

                            <div class="Linha"></div>                       <!--Linha de separação-->

                        </div>                                                     <!--Fechando info profissional-->

                        <div class="Profissionais-descricao">                      <!--Abrindo descrição profissional-->
                        ...
                        </div>                                                     <!--Fechando descrição profissional-->

                    </div>                                                          <!--Fechando profissionais-->


                    <div class="Profissionais-docentes">                            <!--Abrindo profissionais-->

                        <!--div class="Profissionais-foto-marcia" ></div--> <!--Foto profissional-->

                        <div class="Profissionais-info">                     <!--Abrindo info profissional-->

                            <h2>Atuação</h2>                    <!--Nome profissional-->
                            <h4>Nutricionista</h4>              <!--Função profissional-->
                    ...
                    <div class="Profissionais-docentes">                            <!--Abrindo profissionais-->
                        ...
                        <!--div class="Profissionais-foto-paloma" ></div--> <!--Foto profissional-->

                        <div class="Profissionais-info">                   <!--Abrindo info profissional-->

                            <h2>Atuação</h2>                    <!--Nome profissional-->
                            <h4>Musicoterapeuta</h4>            <!--Função profissional-->
                    ...
                    <div class="Profissionais-docentes">                            <!--Abrindo profissionais-->
                        ...
                        <!--div class="Profissionais-foto-paula" ></div-->  <!--Foto profissional-->

                        <div class="Profissionais-info">                    <!--Abrindo info profissional-->

                            <h2>Atuação</h2>                    <!--Nome profissional-->
                            <h4>Psicanalista e Terapeuta</h4>   <!--Função profissional-->
