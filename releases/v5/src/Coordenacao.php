...
<html lang="pt">
    <head>
        ...
        <title>Acolher</title>
        <link rel="stylesheet" href="CSS/Coordenacao.css?v=5">
    ...
    <body>
        ...
        <section class="Principal"><!--Iniciando Principal-->
            ...
            <div class="Centro">
                ...
                <div class="Titulo">
                    <img src="IMG/Profissional_Ini.png" alt="Logotipo do “Espaço Acolher” com tipografia cinza-esverdeada e ícone de pessoa em forma de árvore, simbolizando acolhimento e crescimento.">
                ...
                <form action="senha.php" method="POST">
                    <div class="T50 time"><!--Abrindo t50 time-->
                        ...
                        <div id="caps-warning">⚠️ Caps Lock está ativado!</div>
